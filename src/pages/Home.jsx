    ...
    <div className="max-w-screen-xl mx-auto mt-4">
      ...
      <section className="px-2 lg:flex lg:space-x-2">
        ...
        >
          ...
          <img className="absolute left-0 top-0 w-full h-full z-0 object-cover" src={mahashivaratri} alt="yog" />
        ...
        <NavLink className="w-full lg:w-1/3 bg-purple-300 h-96 mb-4 relative rounded inline-block overflow-hidden">
          <div className="absolute left-0 top-0 w-full h-full z-0 bg-gradient-to-b from-black/5 to-black/20"></div>
          <img className="absolute left-0 top-0 w-full h-full z-0 object-cover" src={logo} alt="yog" />
          <div className="p-4 absolute bottom-0 left-0 z-0">
            <h2 className="text-2xl font-semibold text-gray-100 leading-tight">МДЦ ШактиМа</h2>
          </div>
        </NavLink>
      </section>
